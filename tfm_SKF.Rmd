...
# Añadir una nueva columna que indique si el nivel de HLA-ABC es 'Low' o 'High'
df_hla_nk_expression$HLA_ABC_cat <- ifelse(df_hla_nk_expression$`HLA-ABC` < mean_hla_abc, 'Low', 'High')
