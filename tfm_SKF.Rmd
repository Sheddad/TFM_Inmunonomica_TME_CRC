...
opts_chunk$set(echo=params$printcode,
	             cache=FALSE, # para no reproducir cuando no hay cambios 
               prompt=FALSE,
               tidy=TRUE,
               comment=NA,
               message=FALSE,
...
boxplot_MCPcounter <- function(data, x, y, fill, title) {
...
En concreto, utilizatemos *MCPcounter* para estimar lainfiltración celular del 
...
# NK
bp1 <- boxplot_MCPcounter (exmat_MCP_Clin, grupo, exmat_MCP_Clin$`NK cells`, grupo, "NK cells")
# T cells
