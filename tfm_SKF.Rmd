...
paramétrico de Mann-Whitney U también conocido como el test de Wilcoxon en el 
que se asume que los datos no necesitan ser normalmente distribuidos aunque 
...
# Extraemos los datos de células NK para los grupos MSI y MSS
...
$$
La hipótesis alternativa $H_1$ es que hay una diferencia entre las distribuciones de 
los dos grupos. En nuestro caso la planteamos **Bilateral (Two-sided)**: 
