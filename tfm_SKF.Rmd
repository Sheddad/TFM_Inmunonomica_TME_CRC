...
```{r chunck_HLA_8, fig.width=10, fig.height=10, echo=FALSE}
...
```{r chunck_HLA_13, fig.width=10, fig.height=10, echo=TRUE}
# Generar los gráficos para cada combinación de stage, msi y HLA variable
...
```{r chunck_HLA_14, fig.width=10, fig.height=10, echo=TRUE}
# Generar los gráficos para cada combinación de stage, msi y HLA variable
